                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(lang.tr('1. Sign up with your name, email, and password', '1. 이름, 이메일, 비밀번호로 가입하세요')),
                          const SizedBox(height: 4),
                          Text(lang.tr('2. After logging in, confirm your phone number and email in your profile', '2. 로그인 후 프로필에서 전화번호와 이메일을 확인하세요')),
                          const SizedBox(height: 4),
                          Text(lang.tr('3. Answer the intake questions and submit', '3. 문진 질문에 답하고 제출하세요')),
                          const SizedBox(height: 4),
                          Text(lang.tr('4. You can start with sample wording instead of sensitive real health details', '4. 민감한 실제 건강정보 대신 테스트용 문구로 시작해도 됩니다')),
                          ...
                          Container(
                            ...
                            child: Text(
                              lang.tr(
                                'If sign-up or login fails, the usual cause is that Firebase Email/Password sign-in is not enabled yet.',
                                '회원가입 또는 로그인이 실패하면 가장 흔한 원인은 Firebase 이메일/비밀번호 로그인이 아직 켜지지 않은 경우입니다.',
                              ),
                            ),
                          ),
                        ],
